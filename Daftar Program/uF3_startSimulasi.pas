...
uses uP1_tipeBentukan, uP2_pesan, uF4_stopSimulasi, uF11_tidur, uF5_beliBahan, uF9_makan;
	...
	begin	
		...
		repeat
			...
			case (perintah) of 
				...
				'mainTidur'			: mainTidur(dataSimulasi,dataBahanMentah, dataBahanOlahan, ID, jmlMakan);(*
				...
				(*'olahBahan' 		: if (lelah(dataSimulasi,ID)) then mainTidur(dataSimulasi,dataBahanMentah, dataBahanOlahan, ID, jmlMakan) else mainOlahBahan();
				'jualOlahan'		: if (lelah(dataSimulasi,ID)) then mainTidur(dataSimulasi,dataBahanMentah, dataBahanOlahan, ID, jmlMakan) else mainJualOlahan();
